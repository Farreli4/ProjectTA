          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="dokumenTA.html">Tugas Akhir</a></li>
                <li class="nav-item"> <a class="nav-link" href="dokumenSempro.html">Seminar Proposal</a></li>
                <li class="nav-item"> <a class="nav-link" href="dokumenUjian.html">Ujian Akhir</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
